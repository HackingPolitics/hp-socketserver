...
export class IncomingMessage {
  ...
  readSyncMessageAndApplyItTo(document: Document, connection?: Connection): void {
    ...
    const internalType = this.type // this reads the stream so store the value
    ...
    switch (internalType) {
      ...
      default:
        ...
        // throw new Error(`Unknown message type  ${this.type.toString()}`)
        console.log(`Unknown message type  ${internalType}`)
